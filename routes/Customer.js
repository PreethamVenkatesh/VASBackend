...
const { customerSignUp, customerLogin, getUserDetails,updateUser } = require('../controllers/CustSignup');     // Import the signupVolunteer function from the products controller
